--FREE RELEASES VERSION CHECK
--[[
     SERVER SIDE >>>>>>
--]]

local curVersion = GetResourceMetadata(GetCurrentResourceName(), "version")
local resourceName = "insoChat"

if ins.CheckUpdate then
    CreateThread(function()
        if GetCurrentResourceName() ~= "insoChat" then
            resourceName = "insoChat (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/insoomnia1/insoChat/releases/latest", CheckVersion, "GET")
            Wait(1800000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/insoomnia1/insoChat/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/insoomnia1/insoChat"
            end
        end, "GET")
